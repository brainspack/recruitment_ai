...
export const ERROR_INVALID_CURRENT_PASSWORD = 'Current Password cannot be blank';
export const ERROR_INVALID_NEW_PASSWORD = 'New Password cannot be blank';
export const ERROR_INVALID_CONFIRM_NEW_PASSWORD = 'Confirm New Password cannot be blank';
...
// Image Upload
export const PROCESSING_IMAGE_UPLOAD = 'Processing Image';
